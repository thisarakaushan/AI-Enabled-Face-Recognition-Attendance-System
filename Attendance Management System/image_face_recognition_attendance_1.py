...
if __name__ == "__main__":
    ...
    # Test the code with images from the 'Test_images' folder
    for test_img in os.listdir(test_images):
        test_img_path = os.path.join(test_images, test_img)
        recognize_faces(test_img_path, known_encodings, known_class_names)
